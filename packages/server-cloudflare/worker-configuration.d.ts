/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=test/wrangler.jsonc` (hash: 30ca8de27eb35defad9e2e4c1057c836)
// Runtime types generated with workerd@1.20260708.1 2025-06-01 
interface __BaseEnv_Env {
	STREAMS: DurableObjectNamespace<import("./template/index").StreamObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./template/index");
